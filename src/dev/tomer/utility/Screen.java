...
public class Screen {
    ...
    public int[] update(Camera camera, int[] pixels) {
        ...
        for (int x = 0; x < width; x++) {
            ...
            // length of a ray from current position to next x or y-side
            double sideDistX;
            double sideDistY;

            //length of a ray from one side to next in map
